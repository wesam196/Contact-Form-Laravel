    ...
    <div class="collapsible-container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="image-container mt-5"> <!-- Adjust margin as needed -->
             <img src="src/img/%D8%B9%D9%85%D8%B1%D8%A91.PNG" alt="Description of the image" class="img-fluid rounded"
      ...
      <div class="content iebARE">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="image-container mt-5"> <!-- Adjust margin as needed -->
              <img src="src/img/%D8%B9%D9%85%D8%B1%D8%A92.PNG" alt="Description of the image" class="img-fluid rounded"
                style="width: 100%; max-height: 200px;">
            </div>
            <div class="embed-responsive embed-responsive-16by9 mt-5">
              <iframe class="embed-responsive-item  "
      ...
      <div class="content iebARE  ">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="image-container mt-5"> <!-- Adjust margin as needed -->
               <img src="src/img/%D8%B9%D9%85%D8%B1%D8%A94.PNG"  class="img-fluid rounded"
                style="width: 100%; max-height: 200px;">
            </div>
            <div class="embed-responsive embed-responsive-16by9 mt-5">
              <iframe class="embed-responsive-item  "
      ...
      <div class="content iebARE  ">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="image-container mt-5"> <!-- Adjust margin as needed -->
               <img src="src/img/%D8%B9%D9%85%D8%B1%D8%A95.PNG"  class="img-fluid rounded"
                style="width: 100%; max-height: 200px;">
            </div>
...
Sa'i. There are many barbershops near the Sanctuary.
          ...
          <div class="col-md-6">
            <div class="image-container mt-5"> <!-- Adjust margin as needed -->
             <img src="src/img/wow.PNG"   class="img-fluid rounded"
                style="width: 100%; max-height: 200px;">
            </div>
            <div class="embed-responsive embed-responsive-16by9 mt-5">
              <iframe class="embed-responsive-item  "
